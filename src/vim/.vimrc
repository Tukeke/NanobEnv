...
augroup myfiletypes
  ...
  autocmd FileType html,php,ruby,eruby,yaml set ts=2 sts=2 sw=2 et
...
"# Clevertab, so launches tab or autocompletion.
function! CleverTab()
...
" Spell check for mail and text files
let spell_auto_type="tex,doc,mail"

let mail_alias_source="Abook"
...
"#set autoread
let journal_directory="~/data/journal"
